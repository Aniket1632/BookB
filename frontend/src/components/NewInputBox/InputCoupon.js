...
const InputCoupon = ({ type, placeholder, value, onChange, errorMessage, label, name, icon, style, disabled, defaultValue, min, required = false, handler }) => {
	...
	return (
		<div className={TextBox.form_input}>
			...
			<div className={TextBox.form_input__container} style={{ backgroundColor: '#fff', border: '1px solid #000' ,width: '100%' }}>
				...
				<label style={{ cursor: 'pointer',color: 'black'}} className={TextBox.form_input__label} onClick={handler}>
					Apply
				</label>  
